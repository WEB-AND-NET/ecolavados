...
<script>
    ...
    $("#btn-Insert").click(function(){
        $.post("<?php echo $patch ?>works/associate/save",{id_trabajo:$("#id").val(),id_tarea:$("#task").val(),id_tarea_princial:$("#taskp").val()},function(data){
            getAssociate();
        })
    })
    ...
    function getAssociate(){
        $.post("<?= $patch ?>works/getassociate",{id:$("#id").val()},function(data){
            $(".html").html(data)
            console.log(data)
        })
    }
