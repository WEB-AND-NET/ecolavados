...
<script>
    ...
    $("#btn-Insert").click(function(){
        $.post("<?php echo $patch ?>works/associate/height/save",{id_trabajo:$("#id").val(),id_tarea:$("#task").val(),id_tarea_principal:$("#taskp").val()},function(data){
            getAssociate();
        })
    })
    ...
    function getAssociate(){
        $.post("<?= $patch ?>works/getassociate/height",{id:$("#id").val()},function(data){
            $(".html").html(data)
            console.log(data)
        })
    }
