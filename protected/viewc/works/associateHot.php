...
<br/>
<div class="box ">
    <form id="form1" class="form" action="<?= $patch; ?>/save" method="post" name="form1">
        <div class="box-body">
...
<script>
    ...
    $("#btn-Insert").click(function(){
        $.post("<?php echo $patch ?>works/associate/hot/save",{id_trabajo:$("#id").val(),id_tarea:$("#task").val(),id_tarea_principal:$("#taskp").val()},function(data){
            getAssociate();
        })
    })
    ...
    function getAssociate(){
        $.post("<?= $patch ?>works/getassociate/hot",{id:$("#id").val()},function(data){
            $(".html").html(data)
            console.log(data)
        })
    }
