...
<br/>
    <div class="box ">
        <div class="box-body">
            ...
            <div class="col-md-2 ">
                <label id="l_section">section*</label>
...
$("#btn-insert").click(function(){
    if($("#section").val()=="A"){
        $.post("<?php echo $patch ?>indicators/renderIndicators",{
            year:$("#year").val(),
            month:$("#month").val()
        },function(e){
            $(".response").html(e)
        ...
        $.post("<?php echo $patch ?>indicators/renderIndicatorsb",{
            year:$("#year").val(),
            month:$("#month").val()
        },function(e){
            $(".responseb").html(e)
