...
<section class="content-header">
    <h1>
        <?= ($a->id == "" ? 'Register  tasks for confined spaces' : 'Update  tasks for confined spaces'); ?> 
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?= $patch ?>">Home</a></li>
        <li><a href="<?= $patch ?>clientes">Task</a></li>
        <li class="active"> <?= ($a->id == "" ? 'Register  tasks for confined spaces' : 'Update  tasks for confined spaces'); ?> </li>
    </ol>
</section>
<br/>
<div class="box ">
    <form id="form1" class="form" action="<?= $patch; ?>task/spaces/save" method="post" name="form1">
        <div class="box-body">
            <fieldset style="width:97%;">
                ...
                <div class="col-lg-4">
                    <label id="l_principal">Default*</label>
                    <div class="input-group margin-bottom-20">
                        <span class="input-group-addon" >
                            <i  class="fa fa-code-fork "></i>
                        </span>
                        <select class='form-control' name="defaul" id="defaul">
                            <option <?= $a->defaul=='N' ? 'selected' : ''; ?> value="N">NO</option>
                            <option <?= $a->defaul=='S' ? 'selected' : ''; ?> value="S">SI</option>
                            <option <?= $a->defaul=='N/A' ? 'selected' : ''; ?> value="N/A">N/A</option>
                        </select>
                    </div><!-- /.input group -->
                </div>
...
<script>
    ...
    $('#btn-cancel').click(function () {
        window.location = '<?= $patch; ?>task/spaces';
    });
</script>
