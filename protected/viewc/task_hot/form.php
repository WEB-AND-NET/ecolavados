...
<section class="content-header">
    <h1>
        <?= ($a->id == "" ? 'Register tasks for hot work' : 'Register tasks for hot work'); ?> 
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?= $patch ?>">Home</a></li>
        <li><a href="<?= $patch ?>clientes">Task</a></li>
        <li class="active"> <?= ($a->id == "" ? 'Register tasks for hot work' : 'Register tasks for hot work'); ?> </li>
    </ol>
</section>
<br/>
<div class="box ">
    <form id="form1" class="form" action="<?= $patch; ?>task/hot/save" method="post" name="form1">
        <div class="box-body">
...
<script>
    ...
    $('#btn-cancel').click(function () {
        window.location = '<?= $patch; ?>task/hot';
    });
</script>
