...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->
    ...
    <body>
                ...
                <form name="form1" role="form" class="login-form " action="<?= $patch ?>postlogin" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <button type="submit" class="btn-u btn-block">Enter</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <script type="text/javascript">
            $.backstretch([
                "global/img/login/backgrounds/eco1.jpg",
                "global/img/login/backgrounds/eco2.jpg",
                "global/img/login/backgrounds/eco3.jpg",
                "global/img/login/backgrounds/eco4.jpg",
            ], {
                fade: 1000,
                duration: 7000
            });
