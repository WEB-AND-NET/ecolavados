...
<br/>
<div class="box ">
    <form id="form1" class="form" action="<?= $patch; ?>authorization/save" method="post" name="form1">
        <div class="box-body">
            <fieldset style="width:97%;">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group margin-bottom-20">
                        ...
                        <select <?= ($a->id != "" ? 'disabled' : ''); ?>  class='elements form-control' name="clientes_id" id="clientes_id">
                            <option></option>
                            <?php foreach($data["clientes"] as $cliente){?>
                                <option <?php echo $cliente["id"]==$a->clientes_id ? 'selected' :'' ?> value="<?php echo $cliente["id"] ?>"><?php echo $cliente["nombre"] ?></option>
                            <?php } ?>
                        </select>
                    </div><!-- /.input group -->
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group margin-bottom-20" >
                        ...
                        <select <?= ($a->id != "" ? 'disabled' : ''); ?>  class='form-control' name="tanques_id" id="tanques_id">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" value="<?= $a->reference; ?>" id="reference" name="reference" maxlength="45">
                    </div><!-- /.input group -->
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" value="<?= $a->last_cargo_suggest; ?>" id="last_cargo_suggest" name="last_cargo_suggest" maxlength="45">
                    </div><!-- /.input group -->
                </div>
            ...
            <fieldset style="width:97%;">
                ...
                <div class="col-lg-4">
                        <label id="l_fecha_estimada">Reference Out*</label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-chain "></i>
                            </div>
                            <input type="text" class="form-control pull-right" value="<?= $a->reference_out; ?>" id="reference_out" name="reference_out" >
                        </div><!-- /.input group -->
                    </div>
            ...
            <fieldset>
                ...
                <div class="col-lg-12">
                    ...
                    <textarea class='form-control' name="observation" id="observation" ><?= $a->observation; ?></textarea>
                    </div><!-- /.input group -->
                </div>
            </fieldset>
            ...
            <div class="box-footer col-md-4 pull-right">
                ...
                <input name="to" type="hidden" id="to" value="<?= $data["to"]  ?>" />
            </div>
        </div>
    </form>
</div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        function validateForm() {
            ...
            sErrMsg += ($('#tanques_id').children().length === 0 ? '- Select client.\n' : '');
        ...
        $('#btn-cancel').click(function () {
            window.location = '<?= $patch; ?>authorization';
        });


        $("#tanques_id").change(function(){
            $(".test30").hide();
            $(".test60").hide();
          //  console.log($("#tanques_id option:selected").attr("data-falta30"))
            if($("#tanques_id option:selected").attr("data-falta30") < 4){
                $(".test30").show()
            }
            if($("#tanques_id option:selected").attr("data-falta60") < 4){
                $(".test60").show()
            }
        ...
        function getTanks(idcliente){
            $.post("<?php echo $data["rootUrl"] ?>authorization/getTanques",{
                ...
                if(data){   
                    var html = "<?php echo $a->tanques_id=='' ? "<option   value='N'>[Select]</option>":''  ?>";
                    
                  //  html += `<option   value='N'>[Select]</option>`
                    data.forEach(function(element){
                        console.log(element);
                        
                        html += `<option  data-falta60='${element.falta60}'  data-falta30='${element.falta30}' value='${element.id}'>${element.serial}</option>`
                    })
