...
class EntrysController extends DooController {
   ...
   public function invoice(){
    ...
    public function addschedule(){
        ...
        $this->data["entradas"] = Doo::db()->query("SELECT e.fecha, t.serial,c.nombre,e.id,s.status_name,
        test30,test60,group_concat(concat(i.descripcion,'-',ie.valor)) as damage FROM entrada e 
        INNER  JOIN status s on (s.id=e.status)
