...
$config['IMG_PROFILE'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'/global/img/users/';
$config['IMG_LOGS'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'img_causes_logs/';
$config['IMG_EVIDENCE'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'img_evidences/';
$config['IMG_SEALS'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'img_seals/';
$config['IMG_REQUEST'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'img_request/';
$config['IMG_EVIDENCE_QUALITY'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'img_quality/';
